...
void SheepStateMachine::Initialize()
{
	...
	GetState<EnemiesStates::Sheep_Idle_State>()->CompColumns = 1; //4
	GetState<EnemiesStates::Sheep_Idle_State>()->CompRows = 1;	//2
	GetState<EnemiesStates::Sheep_Idle_State>()->CompSprites = 1;	//8
	GetState<EnemiesStates::Sheep_Idle_State>()->CompDuration = 1;	//2
	GetState<EnemiesStates::Sheep_Idle_State>()->StateTexture = ResourceManager::textures["Dibbo.png"].get(); //"jump.png"
																															//machine->GetState<Jump_State>()->CompDelays.resize(8);
	for (auto& delay : GetState<EnemiesStates::Sheep_Idle_State>()->CompDelays)
		delay = 0.1f;

	GetState<EnemiesStates::Sheep_Patrol_State>()->CompColumns = 1; //4
	GetState<EnemiesStates::Sheep_Patrol_State>()->CompRows = 1;	//2
	GetState<EnemiesStates::Sheep_Patrol_State>()->CompSprites = 1;	//8
	GetState<EnemiesStates::Sheep_Patrol_State>()->CompDuration = 1;	//2
	GetState<EnemiesStates::Sheep_Patrol_State>()->StateTexture = ResourceManager::textures["Dibbo.png"].get(); //"jump.png"
																															  //machine->GetState<Jump_State>()->CompDelays.resize(8);
	for (auto& delay : GetState<EnemiesStates::Sheep_Patrol_State>()->CompDelays)
		delay = 0.1f;

	GetState<EnemiesStates::Sheep_Detection_State>()->CompColumns = 1; //4
	GetState<EnemiesStates::Sheep_Detection_State>()->CompRows = 1;	//2
	GetState<EnemiesStates::Sheep_Detection_State>()->CompSprites = 1;	//8
	GetState<EnemiesStates::Sheep_Detection_State>()->CompDuration = 1;	//2
	GetState<EnemiesStates::Sheep_Detection_State>()->StateTexture = ResourceManager::textures["Dibbo.png"].get(); //"jump.png"
																																 //machine->GetState<Jump_State>()->CompDelays.resize(8);
